...
// Custom colored marker icons per type
...
const MARKER_ICONS = {
  supermarket: createColoredIcon('#3B82F6'),
  palengke:    createColoredIcon('#16a34a'),
  store:       createColoredIcon('#6b7280'),
}
    ...
    <div style={{
      ...
      >
        ...
        <Circle
          center={[userLat, userLon]}
          radius={120}
          pathOptions={{ color: '#16a34a', fillColor: '#4ade80', fillOpacity: 0.35, weight: 2 }}
        />
        ...
        {markers.map(m => (
          <Marker
            ...
            icon={MARKER_ICONS[m.type] ?? MARKER_ICONS.store}
          >
            <Popup>
              <div style={{ minWidth: 140 }}>
                <strong style={{ fontSize: '0.9rem' }}>{m.name}</strong>
                <br />
                <span style={{ fontSize: '0.78rem', color: '#555' }}>{TYPE_LABEL[m.type]}</span>
                {m.address && (
                  <>
                    <br />
                    <span style={{ fontSize: '0.75rem', color: '#888' }}>{m.address}</span>
                  </>
                )}
                <br />
                <a
                  href={`https://www.google.com/maps/dir/${userLat},${userLon}/${m.lat},${m.lon}`}
                  target="_blank"
      ...
      <div style={{
        ...
        padding: '0.4rem 0.75rem', boxShadow: 'var(--s2)',
        fontSize: '0.78rem', fontWeight: 600, color: 'var(--forest)',
